            ...
            case "gui":
                if (args.length >= 3 && sender.hasPermission("kkfish.admin")) {
                    ...
                    Player player = (Player)sender;
                        ...
                        kkfish.log(plugin.getMessageManager().getMessageWithoutPrefix("command_gui_permission_check", "玩家 %s 尝试使用GUI命令，权限检查结果: kkfish.use=%s", player.getName(), player.hasPermission("kkfish.use")));
